...
if __name__ == "__main__":
    ...
    with db_session:
        ...
        pos = {'latitude':56.837773, 'longitude':60.603695, 'name':'Родонитовый монолит'}
        ...
        pos = {'latitude':56.837823, 'longitude':60.596343, 'name':'Памятник Ленину'}
        ...
        pos = {'latitude':56.831074, 'longitude':60.604684, 'name':'Центр современного искусства'}
        ...
        pos = {'latitude':56.836008, 'longitude':60.614662, 'name':'Небоскрёб Высоцкий'}
