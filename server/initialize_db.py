...
if __name__ == "__main__":
    ...
    with db_session:
        ...
        add_event({'name':'Музыкальный вечер', 
              'time_start':'2019-05-25T20:00:00', 
              'time_end':'2019-05-26T00:00:00', 
              'location':loc, 'description':'Будем петь песни и веселиться!', 
              'author':admin})
        ...
        add_event({'name':'Протест КПРФ', 
              ...
              'location':loc, 'description':'Будем снова протестовать против повышения пенсионного возраста!', 
              'author':admin})
        add_event({'name':'Протест КПРФ', 
        ...
        add_event({'name':'Выставка, посвященная Стрит-Арту', 
              ...
              'location':loc, 'description':'Будут представлены работы многих известных артистов ЕКБ.', 
              'author':admin})
        ...
        add_event({'name':'Выставка в музее В.С. Высоцкого', 
              'time_start':'2019-05-20T12:00:00', 
              'time_end':'2019-05-30T20:00:00', 
              'location':loc, 'description':'Ранее неизданные работы и произведения.', 
              'author':admin})
